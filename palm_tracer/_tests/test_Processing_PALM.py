...
# 	""" Test sur le lancement de PALM GPU sur une frame. """
# 	palm = Palm("GPU")
# 	if not palm.is_valid():
# 		print_warning("\n====================\nTest non effectué car DLL manquante\n====================\n")
# 	else:
...
# 	""" Test sur le lancement de PALM GPU sur une pile. """
# 	palm = Palm("GPU")
# 	if not palm.is_valid():
# 		print_warning("\n====================\nTest non effectué car DLL manquante\n====================\n")
# 	else:
...
# 	""" Test sur le lancement de PALM GPU sur une sélection de plans. """
# 	palm = Palm("GPU")
# 	if not palm.is_valid():
# 		print_warning("\n====================\nTest non effectué car DLL manquante\n====================\n")
# 	else:
...
# 	"""	Test sur le lancement de PALM GPU sur une pile ayant des points très localisés. """
# 	palm = Palm("GPU")
# 	if not palm.is_valid():
# 		print_warning("\n====================\nTest non effectué car DLL manquante\n====================\n")
# 	else:
