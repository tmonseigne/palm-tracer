...
class HighResViewer(QMainWindow):
	...
	def load_image(self, image: np.ndarray):
		...
		timer = QTimer()											# Utiliser QTimer pour attendre que la scène soit prête
		timer.singleShot(0, lambda: self.view.fitInView(self.image_item, Qt.AspectRatioMode.KeepAspectRatio))
